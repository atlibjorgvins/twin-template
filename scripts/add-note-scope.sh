#!/usr/bin/env bash
# Add a Work/Private `scope` field to the notes collection, matching the
# field that already exists on Activity / people / orgs / projects.
#   notes.scope  string select-dropdown: work | private | both (nullable)
